...
- Prompt Engineering
- Context Engineering
- Claude Code — fundamentals and advanced
- Skills, sub-agents and plugins
...
### Module 4
> Details to be added from the original SMIT course information.
...
- GitHub: [github.com/mkx-hub](https://github.com/mkx-hub)

<!-- Add contact links here when available (e.g. email, LinkedIn). -->